...
public class ObjectFactory {
    ...
    private final static QName _GetInfoResponse_QNAME = new QName("http://services/", "getInfoResponse");
    private final static QName _GetInfo_QNAME = new QName("http://services/", "getInfo");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services/", name = "getInfoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services/", name = "getInfo")
