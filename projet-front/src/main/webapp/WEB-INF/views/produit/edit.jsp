	...
	<div class="container">
		...
		<form:form action="${ctx}/produit/save" method="post"
			...
			<div class="form-group">
				...
				<form:input path="nom" cssClass="form-control" equired="required" />
			...
			<div class="form-group">
				...
				<a href="${ctx}/produit?info=cancel" class="btn btn-outline-warning">annuler</a>
			</div>
		</form:form>
	</div>
</body>
