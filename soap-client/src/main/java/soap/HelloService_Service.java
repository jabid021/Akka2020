 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://soap/", wsdlLocation = "http://localhost:8080/soap/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://soap/", "HelloService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://soap/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap/", "HelloServicePort"), HelloService.class, features);
    }
